...
#### 1. Kelas Mahasiswa dan Inisialisasi Data
      Pada bagian awal, kelas Mahasiswa dibuat untuk menampung seluruh fungsi pengelolaan data. Di dalam method __init__, dibentuk sebuah list kosong bernama self.data
      yang akan digunakan untuk menyimpan semua data mahasiswa dalam bentuk dictionary. Dengan struktur ini,     
